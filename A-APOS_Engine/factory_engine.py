...
class Lot:
    def __init__(self, lot_id, part, start_time, priority, setup_req):
        ...
        self.wait_event = None # For batching
...
class AdvancedStation:
    ...
    def process(self, lot, ptime, setup_req, setup_cost):
        ...
        # 3. Processing with Preemption (Failures)
